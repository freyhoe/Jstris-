      ...
      function updateUI() {
        switch (status) {
          case UI_STATUS.queueing:
            if (HOVERING) {
              p.innerHTML = "Exit Matchmaking"
            } else {
              p.innerHTML = toMMSS(timeInQueue)
            }
            queueinfo.innerHTML = "" + numQueue + " in queue"
            break;
          case UI_STATUS.idle:
            p.innerHTML = "Enter Matchmaking"
            queueinfo.innerHTML = "" + numQueue + " in queue"
          ...
          case UI_STATUS.declined:
            queueinfo.innerHTML = "You Are Already In Queue"
            p.remove()
            break;
          case UI_STATUS.banned:
            queueinfo.innerHTML = "You Are Banned"
            p.remove()
            break;
        }
      }
